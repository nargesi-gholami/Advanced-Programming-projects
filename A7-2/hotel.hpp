...
class Hotel
{
    public:
		...
		int get_standard_price() { return standard_room_price; }
		int get_deluxe_price() { return deluxe_room_price; }
		int get_luxary_price() { return luxury_room_price; }
		int get_premium_price() { return premium_room_price; }
		float get_overall_rating() { return overall_avg; }
		...
		void put_average_rate(float location_avg, float cleanless_avg, float staff_avg,
			float facilities_avg, float value_avg, float overall_avg);
		float get_rate(Consumer* temp_consumer);
		float cal_overall_rating(Consumer* temp_consumer);
		float estimate_weights(Consumer* temp_consumer);
